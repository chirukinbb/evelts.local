...
Route::post('admin/loginAction',
    [\App\Http\Controllers\Admin\MainController::class, 'loginAction'])->name('admin.loginAction');
...
Route::middleware(\App\Http\Middleware\AdminRoleChecker::class)->group(function () {
    ...
    Route::resource('admin/categories',
        \App\Http\Controllers\Admin\CategoryController::class)->names('admin.categories');
...
Route::get('p/{id}', [\App\Http\Controllers\Api\EventSubEntitiesController::class, 'addPhoto']);
